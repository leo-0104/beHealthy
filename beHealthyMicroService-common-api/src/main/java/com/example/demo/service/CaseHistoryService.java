...
public interface CaseHistoryService {
    ...
    @PostMapping("/caseHistory/getAllByCondition/{uid}/{fid}/{query}")
    public List<CaseHistory> getAllByCondition(@PathVariable("uid")Integer uid,@PathVariable("fid")Integer fid,@PathVariable("query")String query);
}
